...
Indexation de la mémoire HashMap sur hash 64 bits du HV Index LSH + HashMap (recherche approximative en temps constant) Passage à l'échelle 50 k tokens sans dégradation de vitesse
Apprentissage Bundling naïf une seule passe Apprentissage itératif par correction d'erreur (perceptron binaire) Améliore la précision de 10–20 % sur les données d'entraînement
Évaluation Accuracy@1/@3 + Perplexité, top-5 accuracy, temps par token, mémoire Comparaison directe avec les modèles neuronaux
